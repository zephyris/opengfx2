...
def buildings_base_flatten(name, scale, verbose=True):
  print("Building flatten", name)
  ...
  building_pal_name = os.path.join(base_path, "pygen", name+"_palmask.png")
  ground_pal_name = os.path.join(base_path, "pygen", name+"_base_palmask.png")
  building_32bpp_name = os.path.join(base_path, "pygen", name+"_32bpp.png")
  ground_32bpp_name = os.path.join(base_path, "pygen", name+"_base_32bpp.png")
  outname = os.path.join(base_path, "pygen", name+"_combo_32bpp.png")

  if check_self_update(outname) or check_update_needed([building_pal_name, ground_pal_name, building_32bpp_name, ground_32bpp_name], outname):
    print("  ", "Generating", os.path.basename(outname))
    ...
    out_pal.save(os.path.join(base_path, "pygen", name+"_combo_palmask.png"))
  else:
    print("  ", "Skipped", os.path.basename(outname))

if __name__ == "__main__":
  buildings_base_flatten(sys.argv[1], int(sys.argv[2]))
